 ...
 * в котором может быть сколько угодно рядов,
 * а также произвольное число элементов в ряду.
 * Необходимо перебрать массив и сравнить каждый элемент со значением el которое мы передаем в параметрах метода. При этом:
 *
